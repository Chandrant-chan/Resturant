    ...
    return (
        <>
                ...
                <Container>
                    <AnimatedBox sx={{ textAlign: 'center', mb: 6 }}>
                        ...
                        <Typography variant="body1" sx={{ maxWidth: '800px', margin: '16px auto', fontFamily: 'Georgia, serif', color: '#FFEB3B' }}>
                            Bansi Restaurant was founded in 2024 with the goal of bringing authentic flavors to our community. Our chefs use only the freshest ingredients to create dishes that celebrate tradition and innovation.
                        </Typography>
                    </AnimatedBox>
            ...
            <Box sx={{ py: 4, backgroundColor: '#111', color: 'white', textAlign: 'center' }}>
                <Container>
                    <Typography variant="body2">© 2024 Bansi Ghanva. All Rights Reserved.</Typography>
                </Container>
            </Box>
        </>
    );
